...
export const mockDoctors = [
  ...
  },
  {
    ...
    languages: ['English', 'Spanish'],
    location: 'ENT Clinic - Building A',
    phone: '+1 (555) 789-0123',
    email: 'd.martinez@hospital.com',
    bio: 'Specialist in ear, nose, and throat conditions including hearing loss and sinusitis.',
    image: '/assets/doctors/dr-david-martinez.jpg',
    isAvailable: true,
    nextAvailable: '2024-01-16',
    symptoms: ['ear pain', 'sore throat', 'hearing loss', 'sinusitis', 'tinnitus']
  },
  {
    id: 'doc_008',
    ...
    bio: 'Expert in eye care, cataracts, refractive surgery, and preventive ophthalmology.',
    image: '/assets/doctors/dr-priya-sharma.jpg',
    isAvailable: true,
    nextAvailable: '2024-01-17',
    symptoms: ['blurred vision', 'eye pain', 'dry eyes', 'floaters', 'vision loss']
  },
  {
    id: 'doc_009',
    ...
    availableTime: '09:00 AM - 05:00 PM',
    languages: ['English'],
    location: 'Dental Clinic - Building D',
    phone: '+1 (555) 901-2345',
    email: 'p.brown@hospital.com',
    bio: 'Comprehensive dental care including cleanings, fillings, root canals, and cosmetic dentistry.',
    image: '/assets/doctors/dr-patricia-brown.jpg',
    isAvailable: true,
    nextAvailable: '2024-01-15',
    symptoms: ['tooth pain', 'gum disease', 'cavity', 'bad breath', 'teeth whitening']
  },
  {
    id: 'doc_010',
    ...
    bio: 'Specialized in women\'s health, pregnancy care, and reproductive health management.',
    image: '/assets/doctors/dr-amanda-thompson.jpg',
    isAvailable: true,
    nextAvailable: '2024-01-18',
    symptoms: ['period pain', 'pregnancy', 'hormone imbalance', 'menopause', 'gynecological issues']
  },
  {
    id: 'doc_011',
    ...
    location: 'Mental Health Clinic - Building E',
    phone: '+1 (555) 123-4567',
    email: 'c.lee@hospital.com',
    bio: 'Mental health specialist with expertise in depression, anxiety, PTSD, and stress management.',
    image: '/assets/doctors/dr-christopher-lee.jpg',
    isAvailable: true,
    nextAvailable: '2024-01-19',
    symptoms: ['anxiety', 'depression', 'stress', 'panic attacks', 'insomnia']
  },
  {
    id: 'doc_012',
    ...
    location: 'Digestive Health Center - Floor 3',
    phone: '+1 (555) 234-5678',
    email: 'm.johnson@hospital.com',
    bio: 'Expert in digestive system disorders including IBS, GERD, and gastrointestinal endoscopy.',
    image: '/assets/doctors/dr-marcus-johnson.jpg',
    isAvailable: true,
    nextAvailable: '2024-01-16',
    symptoms: ['stomach pain', 'acid reflux', 'diarrhea', 'constipation', 'indigestion']
  },
  {
    id: 'doc_013',
    ...
    consultationFee: 165,
    availableDays: ['Mon', 'Wed', 'Fri'],
    availableTime: '08:30 AM - 05:30 PM',
    languages: ['English', 'Italian'],
    location: 'Respiratory Care Center - Floor 4',
    phone: '+1 (555) 345-6789',
    email: 'v.anderson@hospital.com',
    bio: 'Lung specialist with expertise in asthma, COPD, and respiratory infections.',
    image: '/assets/doctors/dr-victoria-anderson.jpg',
    isAvailable: true,
    nextAvailable: '2024-01-15',
    symptoms: ['cough', 'shortness of breath', 'asthma', 'bronchitis', 'wheezing']
  },
  {
    id: 'doc_014',
    ...
    location: 'Diabetes & Hormones Center - Floor 2',
    phone: '+1 (555) 456-7890',
    email: 'r.kumar@hospital.com',
    bio: 'Specialist in diabetes, thyroid disorders, and metabolic diseases.',
    image: '/assets/doctors/dr-rajesh-kumar.jpg',
    isAvailable: true,
    nextAvailable: '2024-01-17',
    symptoms: ['diabetes', 'thyroid issues', 'weight gain', 'hormonal imbalance', 'fatigue']
  }
];
...
export const mockAppointments = [
  ...
  ,
  {
    ...
    priority: 'urgent',
    status: 'completed',
    notes: 'Fracture stabilized, cast applied. Physiotherapy recommended',
    followUpRequired: true,
  ...
  },
  {
    ...
    priority: 'normal',
    status: 'completed',
    notes: 'MRI advised; started migraine prophylaxis',
    followUpRequired: true,
  ...
  },
  {
    ...
    symptoms: ['fatigue', 'routine blood tests'],
    priority: 'low',
    status: 'completed',
    notes: 'Blood tests normal; advised vitamins and rest',
    followUpRequired: false,
    location: 'Main Hospital - Floor 1',
    roomNumber: '103',
    duration: 30
  },
  {
    ...
    priority: 'low',
    status: 'completed',
    notes: 'Routine vaccination administered; no immediate reactions',
    followUpRequired: false,
    location: 'Children\'s Wing - Floor 2',
    roomNumber: '209',
    duration: 30
  },
  {
    ...
    priority: 'low',
    status: 'confirmed',
    notes: 'Blood pressure controlled; continue current meds',
    followUpRequired: false,
    location: 'Main Hospital - Floor 3',
    roomNumber: '305',
    duration: 30
